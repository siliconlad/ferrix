...
macro_rules! impl_vv_sub_assign_view {
    ($lhs:ty, $rhs:ty) => {
        impl<T: Numeric, const N: usize, const M: usize> SubAssign<$rhs> for $lhs {
            fn sub_assign(&mut self, other: $rhs) {
                (0..N).for_each(|i| self[i] -= other[i]);
            }
        }
    ...
    ($lhs:ty) => {
        impl<T: Numeric, const N: usize, const M: usize> SubAssign<T> for $lhs {
            fn sub_assign(&mut self, scalar: T) {
                (0..N).for_each(|i| self[i] -= scalar);
            }
        }
...
macro_rules! impl_vv_sub_assign_view_view {
    ($lhs:ty, $rhs:ty) => {
        impl<T: Numeric, const A: usize, const N: usize, const M: usize> SubAssign<$rhs> for $lhs {
            fn sub_assign(&mut self, other: $rhs) {
                (0..N).for_each(|i| self[i] -= other[i]);
            }
        }
    ...
    ($lhs:ty) => {
        impl<T: Numeric, const A: usize, const N: usize, const M: usize> SubAssign<T> for $lhs {
            fn sub_assign(&mut self, scalar: T) {
                (0..N).for_each(|i| self[i] -= scalar);
            }
        }
...
impl_vv_sub_assign!(Vector<T, N>, &Vector<T, N>);
impl_vv_sub_assign_view!(Vector<T, M>, VectorView<'_, T, N, M>);
impl_vv_sub_assign_view!(Vector<T, M>, &VectorView<'_, T, N, M>);
impl_vv_sub_assign_view!(Vector<T, M>, VectorViewMut<'_, T, N, M>);
impl_vv_sub_assign_view!(Vector<T, M>, &VectorViewMut<'_, T, N, M>);
impl_vv_sub_assign_view!(Vector<T, M>, RowVectorTransposeView<'_, T, N, M>);
impl_vv_sub_assign_view!(Vector<T, M>, &RowVectorTransposeView<'_, T, N, M>);
impl_vv_sub_assign_view!(Vector<T, M>, RowVectorTransposeViewMut<'_, T, N, M>);
impl_vv_sub_assign_view!(Vector<T, M>, &RowVectorTransposeViewMut<'_, T, N, M>);
...
impl_vv_sub_assign_view!(VectorViewMut<'_, T, N, M>); // Scalar
impl_vv_sub_assign_view!(VectorViewMut<'_, T, N, M>, Vector<T, M>);
impl_vv_sub_assign_view!(VectorViewMut<'_, T, N, M>, &Vector<T, M>);
impl_vv_sub_assign_view_view!(VectorViewMut<'_, T, A, M>, VectorView<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorViewMut<'_, T, A, M>, &VectorView<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorViewMut<'_, T, A, M>, VectorViewMut<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorViewMut<'_, T, A, M>, &VectorViewMut<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorViewMut<'_, T, A, M>, RowVectorTransposeView<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorViewMut<'_, T, A, M>, &RowVectorTransposeView<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorViewMut<'_, T, A, M>, RowVectorTransposeViewMut<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorViewMut<'_, T, A, M>, &RowVectorTransposeViewMut<'_, T, N, M>);
...
impl_vv_sub_assign_view!(VectorTransposeViewMut<'_, T, N, M>);  // Scalar
impl_vv_sub_assign_view!(VectorTransposeViewMut<'_, T, N, M>, RowVector<T, M>);
impl_vv_sub_assign_view!(VectorTransposeViewMut<'_, T, N, M>, &RowVector<T, M>);
impl_vv_sub_assign_view_view!(VectorTransposeViewMut<'_, T, A, M>, RowVectorView<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorTransposeViewMut<'_, T, A, M>, &RowVectorView<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorTransposeViewMut<'_, T, A, M>, RowVectorViewMut<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorTransposeViewMut<'_, T, A, M>, &RowVectorViewMut<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorTransposeViewMut<'_, T, A, M>, VectorTransposeView<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorTransposeViewMut<'_, T, A, M>, &VectorTransposeView<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorTransposeViewMut<'_, T, A, M>, VectorTransposeViewMut<'_, T, N, M>);
impl_vv_sub_assign_view_view!(VectorTransposeViewMut<'_, T, A, M>, &VectorTransposeViewMut<'_, T, N, M>);
...
impl_vv_sub_assign_view!(RowVector<T, M>, VectorTransposeView<'_, T, N, M>);
impl_vv_sub_assign_view!(RowVector<T, M>, &VectorTransposeView<'_, T, N, M>);
impl_vv_sub_assign_view!(RowVector<T, M>, VectorTransposeViewMut<'_, T, N, M>);
impl_vv_sub_assign_view!(RowVector<T, M>, &VectorTransposeViewMut<'_, T, N, M>);
...
impl_vv_sub_assign_view_view!(RowVectorViewMut<'_, T, A, M>, VectorTransposeView<'_, T, N, M>);
impl_vv_sub_assign_view_view!(RowVectorViewMut<'_, T, A, M>, &VectorTransposeView<'_, T, N, M>);
impl_vv_sub_assign_view_view!(RowVectorViewMut<'_, T, A, M>, VectorTransposeViewMut<'_, T, N, M>);
impl_vv_sub_assign_view_view!(RowVectorViewMut<'_, T, A, M>, &VectorTransposeViewMut<'_, T, N, M>);
...
impl_vv_sub_assign_view!(RowVectorTransposeViewMut<'_, T, N, M>, Vector<T, M>);
impl_vv_sub_assign_view!(RowVectorTransposeViewMut<'_, T, N, M>, &Vector<T, M>);
impl_vv_sub_assign_view_view!(RowVectorTransposeViewMut<'_, T, N, M>, VectorView<'_, T, A, M>);
impl_vv_sub_assign_view_view!(RowVectorTransposeViewMut<'_, T, N, M>, &VectorView<'_, T, A, M>);
impl_vv_sub_assign_view_view!(RowVectorTransposeViewMut<'_, T, N, M>, VectorViewMut<'_, T, A, M>);
impl_vv_sub_assign_view_view!(RowVectorTransposeViewMut<'_, T, N, M>, &VectorViewMut<'_, T, A, M>);
...
// Scalar
impl_mm_sub_assign!(Matrix<T, M, N>);
...
// Scalar
impl_mm_sub_assign_view!(MatrixViewMut<'_, T, A, B, M, N>);
impl_mm_sub_assign_view!(MatrixViewMut<'_, T, A, B, M, N>, Matrix<T, M, N>);
impl_mm_sub_assign_view!(MatrixViewMut<'_, T, A, B, M, N>, &Matrix<T, M, N>);
impl_mm_sub_assign_view_view!(MatrixViewMut<'_, T, A, B, M, N>, MatrixView<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixViewMut<'_, T, A, B, M, N>, &MatrixView<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixViewMut<'_, T, A, B, M, N>, MatrixViewMut<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixViewMut<'_, T, A, B, M, N>, &MatrixViewMut<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixViewMut<'_, T, A, B, M, N>, MatrixTransposeView<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixViewMut<'_, T, A, B, M, N>, &MatrixTransposeView<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixViewMut<'_, T, A, B, M, N>, MatrixTransposeViewMut<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixViewMut<'_, T, A, B, M, N>, &MatrixTransposeViewMut<'_, T, C, D, M, N>);
...
// Scalar
impl_mm_sub_assign_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>);
impl_mm_sub_assign_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>, Matrix<T, M, N>);
impl_mm_sub_assign_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>, &Matrix<T, M, N>);
impl_mm_sub_assign_view_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>, MatrixView<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>, &MatrixView<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>, MatrixViewMut<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>, &MatrixViewMut<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>, MatrixTransposeView<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>, &MatrixTransposeView<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>, MatrixTransposeViewMut<'_, T, C, D, M, N>);
impl_mm_sub_assign_view_view!(MatrixTransposeViewMut<'_, T, A, B, M, N>, &MatrixTransposeViewMut<'_, T, C, D, M, N>);

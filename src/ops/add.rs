...
mod tests {
    ...
    fn test_matrix_add() {
        ...
        assert_eq!(result, Matrix::<i32, 3, 2>::new([[6, 10], [9, 13], [12, 16]]));
    ...
    fn test_matrix_view_mut_add() {
        ...
        let view_mut = m1.view_mut::<2, 3>((0, 0));
        let t_view = m2.t();

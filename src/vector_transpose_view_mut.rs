...
impl<T: Numeric, const N: usize, const M: usize> Index<(usize, usize)> for VectorTransposeViewMut<'_, T, N, M> {
    type Output = T;
...
impl<T: Numeric, const N: usize, const M: usize> IndexMut<(usize, usize)> for VectorTransposeViewMut<'_, T, N, M> {

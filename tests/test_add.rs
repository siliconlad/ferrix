...
mod tests {
    ...
    #[test]
    fn test_vector_transpose_view_add() {
        // VectorTransposeView + Scalar
        let v1 = Vector::<i32, 3>::new([1, 2, 3]);
        let result = v1.t() + 10;
        assert_eq!(result, Vector::<i32, 3>::new([11, 12, 13]));
